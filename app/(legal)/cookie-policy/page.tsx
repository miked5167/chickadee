            ...
            <div className="mt-5 overflow-x-auto">
              <table className="min-w-full border-collapse overflow-hidden rounded-lg bg-white text-left text-sm">
                ...
                <tbody className="divide-y divide-slate-200">
                  ...
                  <tr><td className="p-4 font-semibold">directory_session</td><td className="p-4">Groups profile views and contact clicks into an anonymous browser session. Expires after 30 minutes without another recorded event.</td><td className="p-4">Only after you allow analytics.</td></tr>
