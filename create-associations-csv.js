...
fs.writeFileSync('all-associations.csv', csvHeader + csvRows.join('\n'));

console.log(`✓ Created all-associations.csv with ${csvRows.length} associations`);
...
fs.writeFileSync('leagues-summary.csv', leaguesCsvHeader + leaguesCsvRows.join('\n'));

console.log(`✓ Created leagues-summary.csv with ${leagues.length} leagues`);
